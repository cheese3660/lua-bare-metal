...
/* LWJGL keycodes
 * from https://github.com/LWJGL/lwjgl/blob/2df01dd762e20ca0871edb75daf670ccacc89b60/src/java/org/lwjgl/input/Keyboard.java
 */
...
#define KEY_F16               0x67 /* Extended Function keys - (Mac) */
#define KEY_F17               0x68
#define KEY_F18               0x69
#define KEY_KANA              0x70 /* (Japanese keyboard)            */
#define KEY_F19               0x71 /* Extended Function keys - (Mac) */
...
#define KEY_SECTION           0xA7 /* Section symbol (Mac) */
...
#define KEY_FUNCTION          0xC4 /* Function (Mac) */
...
#define KEY_CLEAR             0xDA /* Clear key (Mac) */
#define KEY_LMETA             0xDB /* Left Windows/Option key */
#define KEY_RMETA             0xDC /* Right Windows/Option key */
